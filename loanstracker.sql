...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2023 at 12:28 AM
...
INSERT INTO `bank_accounts` (`id`, `account_name`, `account_number`, `branch`, `nin_number`) VALUES
(1, 'David Omadi', 1003004559, 'Makerere', 'CM930104Y9UC'),
(2, 'Anne Mwebe Nassimbwa', 1003004560, 'Makerere', ''),
(4, 'Ivan Odur', 1003004561, 'Makerere', ''),
(5, 'Mable Birungi', 1003004562, 'Makerere', ''),
(6, 'Irene Ntale', 1003004563, 'Makerere', 'CF2347630HY9UC');
